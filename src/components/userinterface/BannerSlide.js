...
export default function BannerSlide(props) {
  ...
  return (
    <div style={{ width: '97%', height: '100%', position: 'relative', cursor: 'pointer' }}>
      ...
      {!matches ? <div style={{ zIndex: 2, top: '50%', position: 'absolute', display: 'flex', justifyContent: 'center', alignItems: 'center', width: 36, height: 36, borderRadius: 18, background: '#95a5a6', opacity: 0.6 }}>
      ...
      {!matches ?
        <div style={{ zIndex: 2, top: '50%', left: '98%', position: 'absolute', display: 'flex', justifyContent: 'center', alignItems: 'center', width: 36, height: 36, borderRadius: 18, background: '#95a5a6', opacity: 0.6 }}>
